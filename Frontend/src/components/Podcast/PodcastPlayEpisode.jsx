...
const PodcastSeasonsCard = ({items}) => {
  
  return (
    <div>
         <div key={items.title} className="px-4 lg:px-6 py-4 h-auto flex flex-col md:flex-row items-start justify-between gap-4 shadow-xl hover:shadow-2xl transition-all duration-300">
